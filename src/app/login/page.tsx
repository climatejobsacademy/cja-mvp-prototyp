...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col md:flex-row">
      {/*
        Bildpanel bewusst erst ab md sichtbar (mobile-first/PWA): auf kleinen
        Screens darf das Bild das Formular nicht verdrängen. Off-White als
        Hintergrund der Fläche (docs/design-specifications.md Abschnitt 1,
        um --off-white ergänzt), sichtbar bevor/falls login-hero.png fehlt.
      */}
